...
## Scope
1.  **UI Overhaul**: Reimplement the main list and detail views using the "Stash" design language (SwiftUI).
2.  **Data Model**: Extend `AssetItem` to support AI summaries, tags, and cover art (emoji/color).
3.  **AI Integration**: Implement the "Ask Gemini" chat UI and "Refine Summary" flow (simulated logic initially, preparing for real API).
